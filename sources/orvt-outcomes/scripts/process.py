...
COLUMN_MAP = {
    ...
    "number_per_100_000_population": "number_per_100_000_population",
    "per_100_000_population": "number_per_100_000_population",
}
...
def clean_data(df: pd.DataFrame) -> pd.DataFrame:
    ...
    df["number_per_100_000_population"] = pd.to_numeric(
        df["number_per_100_000_population"], errors="coerce"
    ).astype("float")
...
def main() -> None:
    ...
    combined = combined.sort_values(
        by=["start_of_time_period", "public_health_unit", "outcome"],
